...
export default function BookmarksPage() {
  ...
  const { data, isLoading, hasNextPage } = useBookmarkedPosts({ page, size: 12 });
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2" style={{ color: '#7F0716' }}>
          Saved Posts
        </h1>
        ...
        <>
          ...
          <div className="flex justify-center gap-4">
            <Button
              ...
              style={{
                backgroundColor: page === 1 ? '#ccc' : '#7F0716',
                color: 'white',
              }}
            >
              Previous
            ...
            <Button
              ...
              className="px-6 py-2 rounded-lg"
              style={{
                backgroundColor: !hasNextPage ? '#ccc' : '#7F0716',
                color: 'white',
              }}
            >
              Next
